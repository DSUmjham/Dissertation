--- bgpd/session.c	2009-11-11 13:38:05.000000000 +0000
+++ /usr/ports/net/openbgpd/candidate/session.c	2016-12-23 14:49:25.000000000 +0000
@@ -1,4 +1,4 @@
...
+			clock_gettime(CLOCK_MONOTONIC, &receivedTime);
+			printf("UPDATE received, %f, \n",  TimeSpecToSeconds(&receivedTime));
 			start_timer_holdtime(peer);
